...
python run.py \
    --root_path ./stock/ \
    --data_path AAPL_HALF_RAW.csv \
    --is_training 1 \
    --task_name long_term_forecast \
    --model_id stock'_'$seq_len'_'$pred_len'_'$eval_target \
    --data custom \
    --target DJI_Return \
    --freq d \
    --seq_len $seq_len \
...
#     --is_training 1 \
#     --task_name long_term_forecast \
#     --model_id stock'_'$seq_len'_'$pred_len'_'$eval_target"_"$bs"_"$lr \
#     --data custom \
#     --seq_len $seq_len \
#     --label_len 0 \
#     --pred_len $pred_len \
